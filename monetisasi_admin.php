<?php 
    ...
    $queryPayments = mysqli_query($konek, "SELECT SUM(amount) AS totalAmount, COUNT(*) AS totalTransactions FROM payments") or die(mysqli_error($konek));
    $queryRating = mysqli_query($konek, "SELECT COUNT(*) AS totalReviews FROM rating") or die(mysqli_error($konek));
    ...
    $aksesPremium = round($totalAmount * 0.1); // 10% dari total amount
